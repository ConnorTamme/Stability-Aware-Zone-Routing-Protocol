...
#ifndef __INET__GZRP_GZRPCONTROLPACKETS_M_H
#define __INET__GZRP_GZRPCONTROLPACKETS_M_H
...
/**
 * Class generated from <tt>GZRP/GzrpControlPackets.msg:32</tt> by opp_msgtool.
 * <pre>
...
class NDP_Hello : public ::inet::FieldsChunk
{
  protected:
    ...
    uint16_t seqNum = 0;
    uint8_t *helloExtension = nullptr;
    size_t helloExtension_arraysize = 0;
  ...
  public:
    ...
    virtual void setHelloExtensionArraySize(size_t size);
    virtual size_t getHelloExtensionArraySize() const;
    virtual uint8_t getHelloExtension(size_t k) const;
    virtual void setHelloExtension(size_t k, uint8_t helloExtension);
    virtual void insertHelloExtension(size_t k, uint8_t helloExtension);
    [[deprecated]] void insertHelloExtension(uint8_t helloExtension) {appendHelloExtension(helloExtension);}
    virtual void appendHelloExtension(uint8_t helloExtension);
    virtual void eraseHelloExtension(size_t k);
};
...
/**
 * Struct generated from GZRP/GzrpControlPackets.msg:61 by opp_msgtool.
 */
struct IARP_MetricData
{
    IARP_MetricData();
...
/**
 * Struct generated from GZRP/GzrpControlPackets.msg:68 by opp_msgtool.
 */
struct IARP_LinkDestData
{
    IARP_LinkDestData();
...
/**
 * Class generated from <tt>GZRP/GzrpControlPackets.msg:75</tt> by opp_msgtool.
 * <pre>
...
class IARP_LinkStateUpdate : public ::inet::FieldsChunk
{
  ...
  public:
    ...
    virtual uint8_t getRunningStability() const;
    virtual void setRunningStability(uint8_t runningStability);
...
/**
 * Enum generated from <tt>GZRP/GzrpControlPackets.msg:104</tt> by opp_msgtool.
 * <pre>
 * enum IERP_Type
 * {
 *     IERP_QUERY = 1;
...
/**
 * Class generated from <tt>GZRP/GzrpControlPackets.msg:110</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>GZRP/GzrpControlPackets.msg:125</tt> by opp_msgtool.
 * <pre>
...
template<> inline inet::gzrp::NDP_Hello *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::gzrp::NDP_Hello*>(ptr.get<cObject>()); }
inline any_ptr toAnyPtr(const inet::gzrp::IARP_MetricData *p) {return any_ptr(p);}
template<> inline inet::gzrp::IARP_MetricData *fromAnyPtr(any_ptr ptr) { return ptr.get<inet::gzrp::IARP_MetricData>(); }
inline any_ptr toAnyPtr(const inet::gzrp::IARP_LinkDestData *p) {return any_ptr(p);}
template<> inline inet::gzrp::IARP_LinkDestData *fromAnyPtr(any_ptr ptr) { return ptr.get<inet::gzrp::IARP_LinkDestData>(); }
template<> inline inet::gzrp::IARP_LinkStateUpdate *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::gzrp::IARP_LinkStateUpdate*>(ptr.get<cObject>()); }
template<> inline inet::gzrp::IERP_RouteData *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::gzrp::IERP_RouteData*>(ptr.get<cObject>()); }
template<> inline inet::gzrp::BRP_Data *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::gzrp::BRP_Data*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __INET__GZRP_GZRPCONTROLPACKETS_M_H
