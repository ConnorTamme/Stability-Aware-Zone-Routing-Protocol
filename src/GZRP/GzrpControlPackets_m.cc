//
// Generated file, do not edit! Created by opp_msgtool 6.2 from GZRP/GzrpControlPackets.msg.
//
...
void NDP_Hello::copy(const NDP_Hello& other)
{
    ...
    delete [] this->helloExtension;
    this->helloExtension = (other.helloExtension_arraysize==0) ? nullptr : new uint8_t[other.helloExtension_arraysize];
    helloExtension_arraysize = other.helloExtension_arraysize;
    for (size_t i = 0; i < helloExtension_arraysize; i++) {
        this->helloExtension[i] = other.helloExtension[i];
    }
}
...
void NDP_Hello::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    b->pack(helloExtension_arraysize);
    doParsimArrayPacking(b,this->helloExtension,helloExtension_arraysize);
}
...
void NDP_Hello::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    delete [] this->helloExtension;
    b->unpack(helloExtension_arraysize);
    if (helloExtension_arraysize == 0) {
        this->helloExtension = nullptr;
    } else {
        this->helloExtension = new uint8_t[helloExtension_arraysize];
        doParsimArrayUnpacking(b,this->helloExtension,helloExtension_arraysize);
    }
}
...
size_t NDP_Hello::getHelloExtensionArraySize() const
{
    return helloExtension_arraysize;
}

uint8_t NDP_Hello::getHelloExtension(size_t k) const
{
    if (k >= helloExtension_arraysize) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)helloExtension_arraysize, (unsigned long)k);
    return this->helloExtension[k];
}

void NDP_Hello::setHelloExtensionArraySize(size_t newSize)
{
    handleChange();
    uint8_t *helloExtension2 = (newSize==0) ? nullptr : new uint8_t[newSize];
    size_t minSize = helloExtension_arraysize < newSize ? helloExtension_arraysize : newSize;
    for (size_t i = 0; i < minSize; i++)
        helloExtension2[i] = this->helloExtension[i];
    for (size_t i = minSize; i < newSize; i++)
        helloExtension2[i] = 0;
    delete [] this->helloExtension;
    this->helloExtension = helloExtension2;
    helloExtension_arraysize = newSize;
}

void NDP_Hello::setHelloExtension(size_t k, uint8_t helloExtension)
{
    if (k >= helloExtension_arraysize) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)helloExtension_arraysize, (unsigned long)k);
    handleChange();
    this->helloExtension[k] = helloExtension;
}

void NDP_Hello::insertHelloExtension(size_t k, uint8_t helloExtension)
{
    if (k > helloExtension_arraysize) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)helloExtension_arraysize, (unsigned long)k);
    handleChange();
    size_t newSize = helloExtension_arraysize + 1;
    uint8_t *helloExtension2 = new uint8_t[newSize];
    size_t i;
    for (i = 0; i < k; i++)
        helloExtension2[i] = this->helloExtension[i];
    helloExtension2[k] = helloExtension;
    for (i = k + 1; i < newSize; i++)
        helloExtension2[i] = this->helloExtension[i-1];
    delete [] this->helloExtension;
    this->helloExtension = helloExtension2;
    helloExtension_arraysize = newSize;
}

void NDP_Hello::appendHelloExtension(uint8_t helloExtension)
{
    insertHelloExtension(helloExtension_arraysize, helloExtension);
}

void NDP_Hello::eraseHelloExtension(size_t k)
{
    if (k >= helloExtension_arraysize) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)helloExtension_arraysize, (unsigned long)k);
    handleChange();
    size_t newSize = helloExtension_arraysize - 1;
...
NDP_HelloDescriptor::NDP_HelloDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::gzrp::NDP_Hello)), "inet::FieldsChunk")
{
...
unsigned int NDP_HelloDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISARRAY | FD_ISEDITABLE | FD_ISRESIZABLE,    // FIELD_helloExtension
    };
...
int NDP_HelloDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "helloExtension") == 0) return baseIndex + 2;
...
int NDP_HelloDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    ...
    switch (field) {
        case FIELD_helloExtension: return pp->getHelloExtensionArraySize();
        default: return 0;
    }
}
...
void NDP_HelloDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    ...
    NDP_Hello *pp = omnetpp::fromAnyPtr<NDP_Hello>(object); (void)pp;
    switch (field) {
        case FIELD_helloExtension: pp->setHelloExtensionArraySize(size); break;
...
std::string NDP_HelloDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_helloExtension: return ulong2string(pp->getHelloExtension(i));
        default: return "";
    }
}
...
void NDP_HelloDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_helloExtension: pp->setHelloExtension(i,string2ulong(value)); break;
...
omnetpp::cValue NDP_HelloDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_helloExtension: return (omnetpp::intval_t)(pp->getHelloExtension(i));
...
void NDP_HelloDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_helloExtension: pp->setHelloExtension(i,omnetpp::checked_int_cast<uint8_t>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'NDP_Hello'", field);
    }
}
...
IARP_MetricDataDescriptor::IARP_MetricDataDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::gzrp::IARP_MetricData)), "")
{
    propertyNames = nullptr;
}
...
IARP_LinkDestDataDescriptor::IARP_LinkDestDataDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::gzrp::IARP_LinkDestData)), "")
{
    propertyNames = nullptr;
}
...
const char *IARP_LinkDestDataDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::gzrp::IARP_MetricData",    // FIELD_metrics
    };
...
void IARP_LinkStateUpdate::copy(const IARP_LinkStateUpdate& other)
{
    ...
    this->runningStability = other.runningStability;
...
void IARP_LinkStateUpdate::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->runningStability);
...
void IARP_LinkStateUpdate::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->runningStability);
...
uint8_t IARP_LinkStateUpdate::getRunningStability() const
{
    return this->runningStability;
}

void IARP_LinkStateUpdate::setRunningStability(uint8_t runningStability)
{
    handleChange();
    this->runningStability = runningStability;
}
...
IARP_LinkStateUpdateDescriptor::IARP_LinkStateUpdateDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::gzrp::IARP_LinkStateUpdate)), "inet::FieldsChunk")
{
    propertyNames = nullptr;
}
...
unsigned int IARP_LinkStateUpdateDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_runningStability
...
int IARP_LinkStateUpdateDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "runningStability") == 0) return baseIndex + 3;
...
const char *IARP_LinkStateUpdateDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "uint8_t",    // FIELD_runningStability
        "uint16_t",    // FIELD_reserved1
        "uint8_t",    // FIELD_reserved2
        "uint8_t",    // FIELD_linkDestCount
        "inet::gzrp::IARP_LinkDestData",    // FIELD_linkDestData
    };
...
std::string IARP_LinkStateUpdateDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_runningStability: return ulong2string(pp->getRunningStability());
...
void IARP_LinkStateUpdateDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_runningStability: pp->setRunningStability(string2ulong(value)); break;
...
omnetpp::cValue IARP_LinkStateUpdateDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_runningStability: return (omnetpp::intval_t)(pp->getRunningStability());
...
void IARP_LinkStateUpdateDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_runningStability: pp->setRunningStability(omnetpp::checked_int_cast<uint8_t>(value.intValue())); break;
...
Register_Enum(inet::gzrp::IERP_Type, (inet::gzrp::IERP_Type::IERP_QUERY, inet::gzrp::IERP_Type::IERP_REPLY));
...
IERP_RouteDataDescriptor::IERP_RouteDataDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::gzrp::IERP_RouteData)), "inet::FieldsChunk")
{
    propertyNames = nullptr;
}
...
BRP_DataDescriptor::BRP_DataDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::gzrp::BRP_Data)), "inet::FieldsChunk")
{
    propertyNames = nullptr;
}
...
const char *BRP_DataDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::gzrp::IERP_RouteData",    // FIELD_encapsulatedPacket
    };
