//
// Generated file, do not edit! Created by opp_msgtool 6.2 from SAZRP/SaZrpControlPackets.msg.
//
...
#include <memory>
#include <type_traits>
#include "SaZrpControlPackets_m.h"
...
void NDP_Hello::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->velX);
    doParsimPacking(b,this->velY);
    doParsimPacking(b,this->velZ);
}
...
void NDP_Hello::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->velX);
    doParsimUnpacking(b,this->velY);
    doParsimUnpacking(b,this->velZ);
}
...
float NDP_Hello::getPosX() const
{
    return this->posX;
}

void NDP_Hello::setPosX(float posX)
{
    handleChange();
    this->posX = posX;
}

float NDP_Hello::getPosY() const
{
    return this->posY;
}

void NDP_Hello::setPosY(float posY)
{
    handleChange();
    this->posY = posY;
}

float NDP_Hello::getPosZ() const
{
    return this->posZ;
}

void NDP_Hello::setPosZ(float posZ)
{
    handleChange();
    this->posZ = posZ;
}

float NDP_Hello::getVelX() const
{
    return this->velX;
}

void NDP_Hello::setVelX(float velX)
{
    handleChange();
    this->velX = velX;
}

float NDP_Hello::getVelY() const
{
    return this->velY;
}

void NDP_Hello::setVelY(float velY)
{
    handleChange();
    this->velY = velY;
}

float NDP_Hello::getVelZ() const
{
    return this->velZ;
}

void NDP_Hello::setVelZ(float velZ)
{
    handleChange();
    this->velZ = velZ;
}
...
NDP_HelloDescriptor::NDP_HelloDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::sazrp::NDP_Hello)), "inet::FieldsChunk")
{
...
unsigned int NDP_HelloDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_velX
        FD_ISEDITABLE,    // FIELD_velY
        FD_ISEDITABLE,    // FIELD_velZ
    };
...
int NDP_HelloDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "posZ") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "velX") == 0) return baseIndex + 5;
    if (strcmp(fieldName, "velY") == 0) return baseIndex + 6;
    if (strcmp(fieldName, "velZ") == 0) return baseIndex + 7;
...
std::string NDP_HelloDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_velX: return double2string(pp->getVelX());
        case FIELD_velY: return double2string(pp->getVelY());
        case FIELD_velZ: return double2string(pp->getVelZ());
        default: return "";
    }
}
...
void NDP_HelloDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_velX: pp->setVelX(string2double(value)); break;
        case FIELD_velY: pp->setVelY(string2double(value)); break;
        case FIELD_velZ: pp->setVelZ(string2double(value)); break;
...
omnetpp::cValue NDP_HelloDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_posX: return (double)(pp->getPosX());
        case FIELD_posY: return (double)(pp->getPosY());
        case FIELD_posZ: return (double)(pp->getPosZ());
        case FIELD_velX: return (double)(pp->getVelX());
        case FIELD_velY: return (double)(pp->getVelY());
        case FIELD_velZ: return (double)(pp->getVelZ());
...
void NDP_HelloDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_posX: pp->setPosX(static_cast<float>(value.doubleValue())); break;
        case FIELD_posY: pp->setPosY(static_cast<float>(value.doubleValue())); break;
        case FIELD_posZ: pp->setPosZ(static_cast<float>(value.doubleValue())); break;
        case FIELD_velX: pp->setVelX(static_cast<float>(value.doubleValue())); break;
        case FIELD_velY: pp->setVelY(static_cast<float>(value.doubleValue())); break;
        case FIELD_velZ: pp->setVelZ(static_cast<float>(value.doubleValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'NDP_Hello'", field);
    }
}
...
IARP_MetricDataDescriptor::IARP_MetricDataDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::sazrp::IARP_MetricData)), "")
{
    propertyNames = nullptr;
}
...
IARP_LinkDestDataDescriptor::IARP_LinkDestDataDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::sazrp::IARP_LinkDestData)), "")
{
    propertyNames = nullptr;
}
...
const char *IARP_LinkDestDataDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::sazrp::IARP_MetricData",    // FIELD_metrics
    };
...
IARP_LinkStateUpdateDescriptor::IARP_LinkStateUpdateDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::sazrp::IARP_LinkStateUpdate)), "inet::FieldsChunk")
{
    propertyNames = nullptr;
}
...
const char *IARP_LinkStateUpdateDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::sazrp::IARP_LinkDestData",    // FIELD_linkDestData
    };
    return (field >= 0 && field < 8) ? fieldTypeStrings[field] : nullptr;
}
...
Register_Enum(inet::sazrp::IERP_Type, (inet::sazrp::IERP_Type::IERP_QUERY, inet::sazrp::IERP_Type::IERP_REPLY));
...
IERP_RouteDataDescriptor::IERP_RouteDataDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::sazrp::IERP_RouteData)), "inet::FieldsChunk")
{
    propertyNames = nullptr;
}
...
BRP_DataDescriptor::BRP_DataDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::sazrp::BRP_Data)), "inet::FieldsChunk")
{
    propertyNames = nullptr;
}
...
const char *BRP_DataDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::sazrp::IERP_RouteData",    // FIELD_encapsulatedPacket
    };
